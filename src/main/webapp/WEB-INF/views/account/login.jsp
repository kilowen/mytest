...
<body class="login">
	...
	<div class="content">
		...
		<form class="forget-form" action="${ctx}/register" method="post">
		...
		<form class="register-form" action="${ctx}/register" method="post">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="fa fa-user"></i>
					<input id="loginName" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="loginName" name="loginName"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="fa fa-user"></i>
					<input id="name" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="name" name="name"/>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Password</label>
				<div class="input-icon">
					<i class="fa fa-lock"></i>
					<input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="plainPassword" placeholder="Password" name="plainPassword"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="controls">
					<div class="input-icon">
						<i class="fa fa-check"></i>
						<input id="confirmPassword" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" name="confirmPassword"/>
					</div>
				</div>
			</div>
			<div class="form-group">
